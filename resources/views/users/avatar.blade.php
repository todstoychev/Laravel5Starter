<div class="row">
    <div class="col-sm-6">
        ...
        <a href="#" title="{{ trans('temp.delete') }}" data-href="{{ url(app()->getLocale() .  '/users/delete-avatar') }}" data-toggle="modal" data-target="#delete" class="btn btn-xs btn-danger delete-avatar">
    ...
    <form action="{{ url(app()->getLocale() .  '/users/change-avatar') }}" method="POST" enctype="multipart/form-data">
